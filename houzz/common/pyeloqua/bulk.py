...
class Bulk(Eloqua):
    ...
    def __init__(self, username=None, password=None, company=None, test=False, redis=None, client_id=None, client_secret=None):
        ...
        :return: Bulk object
        """
        Eloqua.__init__(self, username, password, company, test, redis, client_id, client_secret)
    ...
    def create_def(self, name):
        ...
        req = self.post(url=url, auth=self.auth, data=dumps(
    ...
    def start_sync(self):
        ...
        req = self.post(url=self.bulk_base + '/syncs',
                            auth=self.auth,
                            data=dumps({
    ...
    def check_sync(self, uri=None):
        ...
        req = self.get(url=self.bulk_base + uri,
                           auth=self.auth)
